export default [
    ...
    ["High Efficiency Image File Format (HEIF)", "image/heic", ".heic"],
    ["High Efficiency Image File Format (HEIF)", "image/heif", ".heif"],
    ...
    ["Microsoft Information Code","application/x-mscardfile",".crd","Wikipedia: Information Code"],
